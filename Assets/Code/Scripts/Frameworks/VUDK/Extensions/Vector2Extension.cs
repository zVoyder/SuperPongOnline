namespace VUDK.Extensions
{
    ...
    public static class Vector2Extension
    {
        ...
        public static bool IsDistanceGreater(this Vector2 v1, Vector2 v2, float distance)
        {
            return (v1 - v2).sqrMagnitude > distance * distance;
        }
        
        public static bool IsDistanceLess(this Vector2 v1, Vector2 v2, float distance)
        {
            return (v1 - v2).sqrMagnitude < distance * distance;
        }
    }
