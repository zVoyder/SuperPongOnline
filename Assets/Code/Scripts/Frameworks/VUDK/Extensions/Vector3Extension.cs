namespace VUDK.Extensions
{
    ...
    public static class Vector3Extension
    {
        ...
        public static bool IsDistanceGreater(this Vector3 v1, Vector3 v2, float distance)
        {
            return (v1 - v2).sqrMagnitude > distance * distance;
        }
        
        public static bool IsDistanceLess(this Vector3 v1, Vector3 v2, float distance)
        {
            return (v1 - v2).sqrMagnitude < distance * distance;
        }
    }
