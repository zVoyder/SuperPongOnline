...
//     version 1.8.2
//     from Assets/Code/Scripts/Frameworks/VUDK/Features/Main/InputSystem/InputsMap.inputactions
//
...
public partial class @InputsMap: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": ""Arrows"",
                    ""id"": ""e782f259-577e-4b0e-a5e1-20f76b733a13"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""245307c9-17fc-42de-b6e9-9279ec8d1416"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""2ad44073-a1c8-455e-98c8-c9f423965fdc"",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""4cf4e9c4-8b49-40a3-a110-02daa66c4deb"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""89e660e1-60fd-4a11-b945-2a0fca47dd7e"",
    ...
    ~@InputsMap()
    {
        Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, InputsMap.Player.Disable() has not been called.");
        Debug.Assert(!m_Interaction.enabled, "This will cause a leak and performance issues, InputsMap.Interaction.Disable() has not been called.");
        Debug.Assert(!m_Camera.enabled, "This will cause a leak and performance issues, InputsMap.Camera.Disable() has not been called.");
        Debug.Assert(!m_Dialogue.enabled, "This will cause a leak and performance issues, InputsMap.Dialogue.Disable() has not been called.");
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, InputsMap.UI.Disable() has not been called.");
        Debug.Assert(!m_Touches.enabled, "This will cause a leak and performance issues, InputsMap.Touches.Disable() has not been called.");
    }
